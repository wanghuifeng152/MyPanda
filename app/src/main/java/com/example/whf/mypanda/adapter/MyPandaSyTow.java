...
public class MyPandaSyTow extends RecyclerView.Adapter<MyPandaSyTow.ViewHolder> {
    private List<PandaShY.DataBean.PandaliveBean.ListBeanX> list;
    private Context con;
    private OnClickListenre listenre;

    public MyPandaSyTow(List<PandaShY.DataBean.PandaliveBean.ListBeanX> list, Context con) {
        this.list = list;
        this.con = con;
    }

    public MyPandaSyTow.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MyPandaSyTow.ViewHolder holder, final int position) {
