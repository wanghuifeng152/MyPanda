...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        ZGSongDao.createTable(db, ifNotExists);
        ZGStudentDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        ZGSongDao.dropTable(db, ifExists);
        ZGStudentDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(ZGSongDao.class);
        registerDaoClass(ZGStudentDao.class);
    }
